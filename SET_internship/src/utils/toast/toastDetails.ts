...
const WARNING_CONFIG : ToastOptions = {position: 'top-center', clickClosable: true, maxVisibleToasts: 3, className: "warning-toast", duration: 5000};

export default {ERROR_CONFIG, SUCCESS_CONFIG, WARNING_CONFIG};
